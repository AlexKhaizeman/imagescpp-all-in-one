...
// надо ли обрезать (если мы пришли из модифициорованного метода)
unsigned short **channelSegmentationCrop(string path, string info, unsigned short **channel_R, int width, int height, int bi, int points_number, int frameWidth, int frameHeight, double hardness){
	ofstream f;
	...
	temp_view.sync();
	//запись результата
	// temp_image.write(path + "/" + to_string(bi) +"bi" + info + "in_ext.bmp");
	...
	// dst_image.write(path + "/" + to_string(bi) +"bi" + info + "out_ext.bmp");
...
// надо ли обрезать (если мы пришли из модифициорованного метода)
unsigned short **channelSegmentation(string path, string info, unsigned short **channel_R, int width, int height, int bi, int points_number, int frameWidth, int frameHeight, double hardness){
	ofstream f;
	f.open(path + "/output.txt", ios::app);
	f<<"Сегметация канала: " + info<<endl;
	dump("Сегметация канала: " + info);
